...
export const MINDMAP_SYSTEM_PROMPT = `仅输出 JSON，且必须是如下结构：
{
  "mindmap": {
    "root": {
      "text": "中心主题",
      "children": [
        { "text": "分支1", "children": [ { "text": "子分支" } ] },
        { "text": "分支2" }
      ]
    }
  }
...
要求：
- 根节点使用 "root"，每个节点必须包含 "text" 字段（字符串）
- 可选字段仅限 "children"，其值为节点数组
- 不得输出除 JSON 以外的任何内容（包括解释、Markdown、代码块）
- 内容应围绕用户输入的主题进行层级化组织，分支命名简洁清晰，层级不宜过深`
